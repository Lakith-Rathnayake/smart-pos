...
class OrderDataAccessTest {
    ...
    void existsOrderByCustomerId() throws SQLException {
        ...
        CustomerDataAccess.saveCustomer(new Customer("ABC", "Something", "Panadura"));
        SingleConnectionDataSource.getInstance().getConnection().createStatement().executeUpdate("INSERT INTO \"order\" (id, customer_id) VALUES ('111111', 'ABC')");
    ...
    void existsOrderByItemCode() throws SQLException {
        ...
        ItemDataAccess.saveItem(new Item("II12345678", "New Item", 5, new BigDecimal("1250")));
        CustomerDataAccess.saveCustomer(new Customer("ABC", "New name", "Panadura"));
