...
public class ManageCustomerFormController {
    ...
    public void btnAddNew_OnAction(ActionEvent actionEvent) throws IOException {
        for (TextField textFields : new TextField[]{txtCustomerId, txtCustomerName, txtCustomerAddress}) {
            textFields.clear();
        }
    ...
    public void btnDelete_OnAction(ActionEvent actionEvent) {
        try {
            if(OrderDataAccess.existsOrderByCustomerId(txtCustomerId.getText())){
                new Alert(Alert.AlertType.ERROR, "Unable to delete the customer, already associated with an Order");
            } else {
